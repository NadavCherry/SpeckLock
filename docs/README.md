...
| [reports/prior-art-temporal-yolov8.md](reports/prior-art-temporal-yolov8.md) | **Is this idea different from the closest published prior art?** Temporal-YOLOv8 (TNO, *Sensors* 2024), reimplemented and scored the same way. No difference from our arm on either public benchmark; they lead significantly on 2 of 3 seeds above 25 px on ARD-MAV — the same size regime YOLOMG also wins. We lead 1 of 3 seeds on the project's own 8 px task |
